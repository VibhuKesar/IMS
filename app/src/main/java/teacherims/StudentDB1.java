...
public class StudentDB1 extends SQLiteOpenHelper {
    ...
    public StudentDB1(Context context) {
    ...
    public List<StudentView1> getAllStudent()
    {
        SQLiteDatabase db = this.getReadableDatabase();
        List<StudentView1> student=new ArrayList<StudentView1>();
        String selectQuery = "SELECT  * FROM " + TABLE_STUDENT_REG;
        Cursor c = db.rawQuery(selectQuery, null);
        if (c.moveToFirst())
        {
            do {
                StudentView1 stud = new StudentView1();
    ...
    public StudentView1 getStudentREGBY(String regNo)
    {
        SQLiteDatabase db = this.getReadableDatabase();
        StudentView1 stud = new StudentView1();
    ...
    public List<StudentView1> getStudentNameBY(String sname)
    {
        SQLiteDatabase db = this.getReadableDatabase();
        List<StudentView1> student=new ArrayList<StudentView1>();
